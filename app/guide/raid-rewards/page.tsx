    ...
    <div style={{ minHeight: '100vh', paddingBottom: '3rem' }}>
      <div className={styles.guideContainer} style={{ marginTop: '1.5rem' }}>
        ...
        <div className={styles.articleBody}>
          ...
          <h3>벨가르딘 (2026년 8월 5일 출시)</h3>
          <p>
            벨가르딘은 노말(1750), 하드(1770), 나이트메어(1780) 세 난이도의 그림자 레이드입니다.
            나이트메어 기준 총 75,000골드, 하드 62,000골드, 노말 50,000골드로 현재 최고 보상
            레이드입니다. 관문별 클리어 골드와 더보기 비용, 클리어·더보기 재련 재료 수량까지
            출시 당일 확인한 확정치가 로아로골에 반영되어 있습니다.
          </p>
          ...
          <p>
            ...
            벨가르딘 출시 전까지 일반 골드 기준 최고 보상 레이드였고,
