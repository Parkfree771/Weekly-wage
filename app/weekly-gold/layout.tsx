...
export const metadata: Metadata = {
  ...
  description: '로아로골 주간 골드 계산기! 로아 더보기 효율, 로아 레이드 보상을 실시간 거래소 가격으로 계산하세요. 신규 레이드 벨가르딘부터 로아 지평의 성당, 로아 세르카, 로아 카제로스 레이드 골드 수익과 더보기 손익을 한눈에.',
  ...
  openGraph: {
    ...
    description: '로아로골 주간 골드 계산기! 신규 레이드 벨가르딘 포함, 로아 더보기 효율과 로아 지평의 성당/세르카/카제로스 골드 수익을 확인하세요.',
    url: '/weekly-gold',
    siteName: '로아로골',
    locale: 'ko_KR',
    type: 'website',
