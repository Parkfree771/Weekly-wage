...
export const metadata: Metadata = {
  // 1. [핵심] 제목: '세르카'를 맨 앞으로!
  title: '세르카 보상 & 주간 골드 수익 | 더보기 효율 | 로스트아크',

  // 2. [핵심] 설명: '세르카(1710)'로 시작하게 변경
  description: '세르카(1710) 레이드 클리어 골드와 더보기 효율 완벽 정리. 내 캐릭터들의 원정대 주간 골드 수익과 재련 재료 가치를 실시간으로 계산해 드립니다.',

  // 3. 키워드: 세르카 관련 단어 우선 배치
  keywords: '세르카 보상, 세르카 골드, 세르카 더보기, 세르카 효율, 로스트아크, 주간 골드, 골드 계산기, 원정대 주급, 더보기 손익, 레이드 수익, 종막, 카제로스',
