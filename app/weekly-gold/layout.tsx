...
export const metadata: Metadata = {
  title: '로아 주간 골드 계산 | 더보기 보상 손익 | 아이템 시세',
  description: '로스트아크 원정대의 주간 골드 수익을 계산하고 레이드 더보기 보상의 손익을 실시간 거래소 가격으로 분석하세요. 카제로스 레이드(종막, 4막, 3막, 2막, 1막), 그림자 레이드(세르카, 고통의 마녀) 지원.',
  keywords: '로아 주간 골드, 로아 아이템 시세, 로스트아크, 주간 골드, 골드 계산기, 원정대 주급, 더보기 손익, 더보기 보상, 레이드 수익, 골드 파밍, 로아 골드, 로아 거래소, 거래소 가격, 거래소 시세, 로아 시세, 종막, 카제로스, 4막, 3막, 2막, 1막, 세르카, 그림자 레이드, 고통의 마녀, 에스더 무기, 마석, 돌파석, 오레하, 엘릭서',
  openGraph: {
    title: '로아 주간 골드 계산 | 더보기 보상 손익 | 아이템 시세',
    description: '원정대 주간 골드 수익과 더보기 보상 손익을 실시간 거래소 가격으로 계산. 카제로스 레이드(종막, 4막, 3막, 2막, 1막), 그림자 레이드(세르카, 고통의 마녀) 지원',
