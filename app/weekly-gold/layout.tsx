...
export const metadata: Metadata = {
  ...
  keywords: '로아로골, 로아 주간 골드, 로아 골드 계산, 로아 더보기, 로아 더보기 효율, 로아 레이드 보상, 로아 지평의 성당, 지평의 성당 골드, 지평의 성당 더보기, 지평의 성당 보상, 로아 세르카, 로아 카제로스, 로아 주급, 로아 골드 수익, 로스트아크 주간 골드, 더보기 손익, 원정대 주급',
