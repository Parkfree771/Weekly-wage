...
export const metadata: Metadata = {
  // 1. [핵심] 제목: '세르카'를 맨 앞으로!
  title: '세르카 보상 & 주간 골드 수익 | 세르카 클리어 보상 | 로스트아크',

  // 2. [핵심] 설명: '세르카(1710)'로 시작하게 변경
  description: '세르카(1710) 레이드 클리어 보상 정보와 관문별 계승 재료 완벽 정리. 세르카 더보기 효율과 원정대 주간 골드 수익을 실시간 거래소 가격으로 계산해 드립니다.',

  // 3. 키워드: 세르카 관련 단어 우선 배치
  keywords: '세르카 보상, 세르카 클리어 보상, 세르카 관문별 보상, 세르카 계승 재료, 세르카 골드, 세르카 더보기, 세르카 효율, 로스트아크, 주간 골드, 골드 계산기, 원정대 주급, 더보기 손익, 레이드 수익, 종막, 카제로스',

  openGraph: {
    // 카톡 공유 시 제목
    title: '세르카 보상 & 주간 골드 수익 계산기',
