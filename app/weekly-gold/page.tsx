...
const weeklyGoldGuideSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '신규 레이드인 벨가르딘(노말 1750 · 하드 1770 · 나메 1780)은 2026년 8월 5일 출시 예정이지만, 미리 주간 골드 계산에 쓸 수 있도록 지금부터 활성화해 두었습니다. 관문별 클리어 골드와 더보기 비용은 공개된 정보를 역산한 값이라 출시 후 확정치로 갱신됩니다.',
    ],
    bullets: [
      ...
      '벨가르딘 노말·하드·나메 (1750 / 1770 / 1780, 8월 5일 출시 — 미리 활성화)',
    ],
  },
];
