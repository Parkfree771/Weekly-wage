...
const weeklyGoldGuideSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '신규 레이드인 벨가르딘(노말 1750 · 하드 1770 · 나메 1780)은 2026년 8월 5일 출시와 함께 인게임 확정치가 반영되어 있습니다. 관문별 클리어 골드와 더보기 비용은 물론 클리어·더보기 재련 재료까지 실측 값 그대로 주간 골드 계산에 포함됩니다.',
    ],
    bullets: [
      ...
      '벨가르딘 노말·하드·나메 (1750 / 1770 / 1780, 8월 5일 출시)',
    ],
  },
];
