...
const weeklyGoldGuideSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '로골로골은 더보기로 받는 재료 목록 전체를 그날의 거래소 평균 시세로 환산한 총 가치에서, 더보기를 선택하는 데 드는 골드 비용을 뺀 값을 관문별로 계산합니다. 이 값이 양수면 더보기가 이득이라는 뜻으로 초록색으로, 음수면 그냥 기본 골드를 받는 편이 낫다는 뜻으로 빨간색으로 표시해서 매번 직접 손익을 따져볼 필요가 없도록 만들었습니다.',
