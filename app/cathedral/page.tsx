              ...
              sections={[
                {
                  ...
                  paragraphs: [
                    ...
                    '기본 보상 외에 추가 골드를 지불하는 더보기를 선택하면 같은 종류의 재료를 더 많이 받을 수 있습니다. 로아로골은 더보기로 얻는 재료의 실시간 거래소 가치 합계에서 더보기 소모 골드를 뺀 손익을 관문별로 계산해 보여주므로, 재료 시세가 낮아지는 시기에는 더보기가 오히려 손해로 표시되는 경우도 있습니다.',
                  ],
                },
                {
                ...
                },
                {
                  ...
                  paragraphs: [
                    '은총의 파편은 거래소·경매장에서 직접 거래되지 않는 재화라 시세 조회가 불가능합니다. 이 때문에 로아로골은 은총의 파편 60개로 교환할 수 있는 지평의 재련 재료 상자(운명의 파괴석 결정, 수호석 결정, 위대한 돌파석, 운명의 파편으로 구성)의 실시간 거래소 가치 총합을 60으로 나누어 은총의 파편 1개의 대체 가치를 역산합니다.',
