              ...
              sections={[
                {
                  ...
                  paragraphs: [
                    '세르카는 노말(1710) · 하드(1730) · 나메(1740) 세 난이도로 나뉘고, 모두 1관문 · 2관문 2개 관문으로 구성됩니다. 난이도가 올라갈수록 관문 클리어 골드와 더보기 비용이 함께 커지는 구조입니다.',
                    '보상 재료도 난이도별로 달라집니다. 노말은 비계승 재료인 운명의 파괴석 · 운명의 수호석 · 운명의 돌파석을 지급하고, 하드와 나메는 상위 호환인 계승 재료(운명의 파괴석 결정 · 운명의 수호석 결정 · 위대한 운명의 돌파석)와 고통의 가시를 함께 지급합니다. 즉 고통의 가시는 하드 이상 난이도를 클리어해야 얻을 수 있는 재화입니다.',
                  ],
                },
                {
                  heading: '더보기(모험의 서약) 손익 확인 방법',
                  paragraphs: [
                    '각 관문에는 골드를 추가로 지불하고 더 많은 운명의 파편, 계승/비계승 재료, 고통의 가시 등을 받는 더보기 옵션이 있습니다. 이득 여부는 "더보기로 받는 재료의 실시간 거래소 환산 가치 합계"에서 "더보기 비용 골드"를 뺀 값의 부호로 판단합니다.',
                    '위쪽 단계 카드에서 원하는 난이도를 선택하면 관문별 기본 보상과 더보기 보상이 함께 펼쳐지며, 재료 앞 체크박스를 해제하면 이미 보유 중이거나 필요 없는 재료를 계산에서 제외하고 총 가치를 다시 확인할 수 있습니다.',
                  ],
                },
                {
                  heading: '고통의 가시 상점 — 교환 구성과 귀속 조건',
                  paragraphs: [
                    '고통의 가시 상점에는 야금술 · 재봉술 업화(거래 가능 버전 / 원정대 귀속 버전), 고통의 재련 재료 상자, 고통의 재련 보조 재료 주머니, 젬 랜덤 상자(영웅 ~ 고급) 총 7개 교환 항목이 있습니다.',
                    '야금술 업화는 거래 가능 버전이 가시 20개 + 골드 3000으로 캐릭터 주간 2회, 원정대 귀속 버전이 가시 20개만으로 원정대 주간 1회 한도이며, 재봉술 업화는 거래 가능 버전이 가시 10개 + 골드 1500으로 캐릭터 주간 10회, 원정대 귀속 버전이 가시 10개만으로 원정대 주간 5회 한도입니다. 나머지 재련 재료 상자 · 보조 재료 주머니 · 젬 랜덤 상자는 모두 가시 5개로 무제한 교환 가능한 캐릭터 귀속 아이템입니다.',
                  ],
                  bullets: [
                    '재련 재료 상자: 25% 확률로 운명의 파편 · 위대한 돌파석 · 파괴석 결정 · 수호석 결정 중 1종 지급',
                    '보조 재료 주머니: 50% 확률로 용암의 숨결 4개 또는 빙하의 숨결 12개 중 1종 지급',
                    '젬 랜덤 상자: 영웅 등급 총 5% 확률(질서 안정/혼돈 침식 각 1.5%, 질서 견고/혼돈 왜곡 각 0.75%, 질서 불변/혼돈 붕괴 각 0.25%)',
                  ],
                },
                {
                  heading: '고통의 가시 단가는 어떻게 산출되나요',
                  paragraphs: [
                    '고통의 가시 자체는 거래소에서 직접 거래되지 않는 재화이기 때문에, 로골로골은 고통의 재련 재료 상자의 기댓값(각 재료 실시간 시세 × 수량 × 25%의 합)을 구한 뒤 상자 교환에 필요한 가시 5개로 나누어 가시 1개의 실질 가치를 역산합니다.',
                    '이렇게 산출한 단가를 야금술 · 재봉술 업화, 젬 랜덤 상자 등 다른 상점 항목의 교환 비용에도 동일하게 적용해, 가시가 들어가는 모든 교환의 효율을 같은 기준으로 비교할 수 있게 했습니다.',
                  ],
                },
              ]}
              faqs={faqData}
