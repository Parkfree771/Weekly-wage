...
const TEMPLATE_ITEMS: TemplateItem[] = [
  ...
  // ── 젬 ──
  {
    ...
    type: 'expected',
    expectedItems: [
      { itemId: '67400003', probability: 0.03 },
      { itemId: '67400103', probability: 0.015 },
      { itemId: '67400203', probability: 0.005 },
      { itemId: '67410303', probability: 0.03 },
      { itemId: '67410403', probability: 0.015 },
      { itemId: '67410503', probability: 0.005 },
    ],
  },
  {
    id: 'gem-hero',
