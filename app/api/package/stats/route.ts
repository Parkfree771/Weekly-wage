...
//   공유해 함수 호출·DB 읽기가 페이지당 STATS_TTL_S 에 1회로 줄어든다.
...
// - 한 번에 MAX_IDS 개까지. 그 이상은 잘라서 남용을 막는다 — 잘린 글도 숫자는 맞다(ISR 이
//   최신 집계를 이미 실어 보낸다). 글이 이 수를 넘어가면 여기와 갤러리의 STATS_MAX_IDS 를 같이 올린다.
