...
export const metadata: Metadata = {
  title: '로아 재련 비용 계산 | T4 재련 재료 시세 | 재련 계산기',
  description: '로스트아크 T4 재련 비용 계산기. 목표 레벨까지 필요한 재련 재료(명예의 파편, 파괴강석, 수호강석, 돌파석)와 골드를 실시간 거래소 시세로 정확하게 계산합니다. 로아 재련 재료 가격 확인.',
  keywords: '로아 재련 비용, 로아 재련 재료, 로스트아크, T4 재련, 재련 계산기, 재련 비용, 명예의 파편, 명돌, 파괴강석, 수호강석, 찬란한 명예의 파괴강석, 찬란한 명예의 수호강석, 명예의 돌파석, 운명의 파편, 재련 재료 시세, 재련 재료 가격, 골드 계산, 로아 시세',
  openGraph: {
    title: '로아 재련 비용 계산 | T4 재련 재료 시세 | 재련 계산기',
    description: 'T4 재련에 필요한 재료와 골드를 실시간 거래소 시세로 정확하게 계산. 명예의 파편, 파괴강석, 수호강석, 돌파석 가격 확인',
