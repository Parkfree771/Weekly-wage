            ...
            <GuideFaq
              ...
              sections={[
                ...
                },
                {
                  ...
                  paragraphs: [
                    '벨가르딘에는 정복전이라는 도전 콘텐츠가 새롭게 예고되어 있으며, 진행 정도에 따라 무공 칭호 · 유물 칭호 등을 획득할 수 있는 것으로 알려져 있습니다. 다만 로아로골은 정복전 진행 상황이나 칭호 획득 조건 자체를 계산하는 도구는 아니며, 어디까지나 관문 클리어 보상의 골드 · 재료 가치를 실시간 시세로 환산해 보여주는 데 집중합니다.',
