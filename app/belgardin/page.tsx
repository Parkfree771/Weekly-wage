            ...
            <GuideFaq
              ...
              sections={[
                ...
                },
                {
                  ...
                  paragraphs: [
                    '다른 최신 레이드와 마찬가지로 노말(1750) · 하드(1770) · 나메(1780) 세 난이도 모두 1관문 · 2관문 2개 관문으로 구성됩니다. 현재 공개된 클리어 골드는 노말 1관문 20,000골드 · 2관문 30,000골드, 하드 1관문 25,000골드 · 2관문 37,000골드, 나메 1관문 30,000골드 · 2관문 45,000골드입니다.',
                    '더보기(모험의 서약) 비용은 난이도와 무관하게 해당 관문 클리어 골드의 32% 수준으로 책정되어 있습니다. 예를 들어 나메 1관문은 클리어 골드 30,000골드에 더보기 비용 9,600골드로 정확히 32%이고, 노말 · 하드의 각 관문 역시 동일한 비율입니다. 다만 더보기로 받는 재료 수량이 아직 미정이라 더보기 손익 자체는 재료 공개 이후 계산할 수 있습니다.',
                  ],
                },
                {
                  heading: '정복전과 상점 — 출시와 함께 채워질 항목',
                  paragraphs: [
                    '벨가르딘에는 정복전이라는 도전 콘텐츠가 새롭게 예고되어 있으며, 진행 정도에 따라 무공 칭호 · 유물 칭호 등을 획득할 수 있는 것으로 알려져 있습니다. 다만 로골로골은 정복전 진행 상황이나 칭호 획득 조건 자체를 계산하는 도구는 아니며, 어디까지나 관문 클리어 보상의 골드 · 재료 가치를 실시간 시세로 환산해 보여주는 데 집중합니다.',
                    '벨가르딘 상점 역시 교환 목록이 아직 공식적으로 확정되지 않아 현재는 "상점 정보 준비 중"으로 표시됩니다. 세르카의 고통의 가시 상점처럼 소모 재화와 교환 항목이 공개되면, 다른 레이드 페이지와 동일한 방식으로 항목별 교환 효율을 계산해 채울 예정입니다.',
                  ],
                },
              ]}
              faqs={faqData}
