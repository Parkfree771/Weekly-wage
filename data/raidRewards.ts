...
export const raidRewards: RaidReward[] = [
  ...
  },
  {
    ...
    gate: 2,
    materials: [
      { itemId: MATERIAL_IDS.FATE_GUARDIAN_STONE_CRYSTAL, itemName: MATERIAL_NAMES.FATE_GUARDIAN_STONE_CRYSTAL, amount: 2640 },
      { itemId: MATERIAL_IDS.FATE_DESTRUCTION_STONE_CRYSTAL, itemName: MATERIAL_NAMES.FATE_DESTRUCTION_STONE_CRYSTAL, amount: 1320 },
      { itemId: MATERIAL_IDS.FATE_FRAGMENT, itemName: MATERIAL_NAMES.FATE_FRAGMENT, amount: 29800 },
      { itemId: MATERIAL_IDS.GREAT_FATE_BREAKTHROUGH_STONE, itemName: MATERIAL_NAMES.GREAT_FATE_BREAKTHROUGH_STONE, amount: 50 },
    ]
  },
  // 종막 노말
  {
