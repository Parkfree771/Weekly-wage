...
export const PRICE_ITEMS: PriceItem[] = [
  ...
  // 유물 각인서 (거래소) - 전체
  { id: '65203905', name: '아드레날린', shortName: '아드', icon: '/engraving2.webp' },
  { id: '65200505', name: '원한', shortName: '원한', icon: '/engraving2.webp' },
  { id: '65203305', name: '돌격대장', shortName: '돌대', icon: '/engraving2.webp' },
  { id: '65201005', name: '예리한 둔기', shortName: '예둔', icon: '/engraving2.webp' },
  { id: '65203505', name: '질량 증가', shortName: '질증', icon: '/engraving2.webp' },
  { id: '65202805', name: '저주받은 인형', shortName: '저받', icon: '/engraving2.webp' },
  { id: '65203005', name: '기습의 대가', shortName: '기습', icon: '/engraving2.webp' },
  { id: '65203705', name: '타격의 대가', shortName: '타대', icon: '/engraving2.webp' },
  { id: '65203405', name: '각성', shortName: '각성', icon: '/engraving2.webp' },
  { id: '65204105', name: '전문의', shortName: '전문의', icon: '/engraving2.webp' },
  { id: '65200605', name: '슈퍼차지', shortName: '슈차', icon: '/engraving2.webp' },
  { id: '65201505', name: '결투의 대가', shortName: '결대', icon: '/engraving2.webp' },
  // 보석 (경매장)
