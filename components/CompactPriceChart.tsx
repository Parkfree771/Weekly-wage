            ...
            <div className="d-md-none" style={{ width: '100%', height: '280px' }}>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData} margin={{ top: 5, right: 5, left: 0, bottom: 0 }}>
                  ...
                  <YAxis tick={{ fontSize: stats && stats.max >= 1000000 ? 7 : 9, fill: 'var(--text-primary)', fontWeight: '700' }} tickFormatter={formatPrice} width={stats && stats.max >= 1000000 ? 60 : stats && stats.max >= 100000 ? 50 : 35} domain={yAxisConfig.domain} tickCount={yAxisConfig.tickCount} stroke="var(--text-secondary)" strokeWidth={1.5} tickLine={{ stroke: 'var(--text-secondary)', strokeWidth: 1.5 }} axisLine={{ stroke: 'var(--text-secondary)', strokeWidth: 1.5 }} />
