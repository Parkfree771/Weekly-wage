            ...
            <Col lg={2} md={4} sm={6} key={character.characterName}>
              <div className={styles.characterCard}>
                ...
                <div className={styles.charTotal}>
                  <div className={styles.charTotalLine} style={{ flexWrap: 'wrap', rowGap: '2px' }}>
                    <span className={styles.charTotalGold} title="일반 골드 (더보기 차감 후)">
      ...
      <div className={styles.grandTotalBox}>
        <div className={styles.grandTotalRow}>
          <span className={styles.grandTotalItem}>
            <Image src="/gold.webp" alt="일반 골드" title="일반 골드" width={16} height={16} style={{ borderRadius: '3px' }} />
