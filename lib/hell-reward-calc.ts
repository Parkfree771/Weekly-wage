...
// 비추적 유물 각인서 31종 평균가 합 — 2026-08-07 거래소 실시세로 갱신
// (중갑797.5 마나흐름780.1 구슬동자821 바리케이드651.8 속전속결637.3 마나효율334.1 안정336.3
//  선수필승259.1 정기흡수339.2 승부사236.5 급소247.7 정밀단도160.7 분쇄137.1 긴급구조75.4 추진력66.6
//  폭발물37.5 달인의저력67.8 시선집중50.7 약자무시10.4 최마증6.5 부러진뼈14.6 강령술9.4 여신의가호2.5
//  위기모면15.5 에테르6.6 실드관통1.9 강화방패1.5 굳은의지2.2 탈출의명수1.6 번개의분노18 불굴2.6)
export const NON_TRACKED_ENGRAVING_SUM = 6130;
